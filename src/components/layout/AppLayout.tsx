import { Brain, LayoutDashboard, Mail, PlusCircle, Search, Workflow } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900">
      <div className="mx-auto flex max-w-7xl md:gap-6">
        ...
        <main className="w-full flex-1 p-4 pb-24 md:p-8 md:pb-8">
          <Outlet />
        </main>
      </div>
        ...
        <div className="mx-auto grid max-w-md grid-cols-6 gap-1">
          {navItems.map(({ to, label, icon: Icon }) => (
            <NavLink
              ...
              className={({ isActive }) =>
                `flex min-h-11 flex-col items-center justify-center gap-1 rounded-md px-1 py-1 text-xs font-medium ${
